  ...
  Widget build(BuildContext context) {
      return new SplashScreen(
        ...
        backgroundColor: Colors.black,
         image: Image.network("https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQIYyJiTa_oU_LaPZcTxWJ-n0QCW1sqjmQ1qbIDBjaqyHaoiaH5",
        ),
...
class _myHomePageState extends State<homePage> {
  var url =
      "https://raw.githubusercontent.com/lupitaesp/pokemon/master/pokemones.json";
  PokeHub pokeHub;
                    ...
                    child: Hero(
                      ...
                      child: Container(
                        child: Card(
                          ...
                          elevation: 3.0,
                          child: Container(
                            color: Colors.transparent, /* checar color*/
                            child: new Column(
                              mainAxisAlignment:
